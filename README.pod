...
=for HTML <a href="https://travis-ci.org/briandfoy/cpan-critic"><img src="https://travis-ci.org/briandfoy/cpan-critic.svg?branch=master" /></a>
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/CPAN-Critic> or
L<MetaCPAN|http://www.metacpan.org/module/CPAN::Critic>:

=over 4

=item *	L<http://search.cpan.org/dist/CPAN-Critic>

=item *	L<http://www.metacpan.org/module/CPAN::Critic>
